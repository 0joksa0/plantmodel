...
Input generate_input()
{
    Input input = {
        ...
        .nitrogen_saturation = 0.45f,
        .phosphorus_saturation = 0.45f,
        .leaf_biomass = 0.005f,
        .root_biomass = 0.005f,
        .total_biomass = 0.01f,
        .min_leaf_biomass = 0.001f,
